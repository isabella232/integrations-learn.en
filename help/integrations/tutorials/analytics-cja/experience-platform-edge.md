---
title: Integrate Adobe Analytics and Customer Journey Analytics with the Experience Platform Edge tutorial
description: Learn how to integrate Adobe Analytics with Customer Journey Analytics using the AEP Web SDK, AEP Mobile SDK, or the Edge Network Server API. 
...
# Integrate Adobe Analytics and Customer Journey Analytics with the Experience Platform Edge tutorial   
